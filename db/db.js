...
module.exports.get = {
    review: (query,callback) => {
        ...
        const inputMessage = "select customer.profile, customer.name, review.review_date, review.comments from review INNER JOIN stay on review.stay = stay.id INNER JOIN customer on stay.customer=customer.id where host= ?"
